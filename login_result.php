...
if (isset($_POST['submit'])) {
    ...
    $name = $_POST['username'];
    $pass = $_POST['password'];
    $query = "SELECT * FROM registered WHERE  Type = 0";
                            ...
                            <div class="row">
                                <div class="col-lg-10 offset-lg-1">
                                    <div class="contact_form_container">
                                        ...
                                        <form action="login.php" method="get" id="contact_form">
                                            <div class="contact_form_inputs d-flex flex-md-row flex-column justify-content-between align-items-between">
                                                <input name="email" type="email" id="contact_form_name" class="contact_form_name input_field" placeholder="Your Username" required="required" data-error="Username is required.">
                                            ...
                                            <div class="contact_form_button">
                                                <input name="submit" type="submit" value="Login" class="button contact_submit_button">
                                            </div>
                                            <?php echo "<br><br>"."<h4 style='color: #0d82d3'>Wrong Password</h4>";
                                            ?><?php
                                            echo "<input name=\"register\" value='Create Account' type=\"submit\" class=\"button contact_submit_button\">"?>
                                        </form>
    ...
    if($flag==0){
        //echo "<html><head><title></title></head><body><a href='register_result.php'>Click here to register</a></body></html>";?>
        <!DOCTYPE html>
        <html lang="en">
        <head>
            <title>Login</title>
                        ...
                        <div class="col-lg-10 offset-lg-1">
                            <div class="contact_form_container">
                                ...
                                <form action="login.php" method="get" id="contact_form">
                                    ...
                                    <?php
                                    echo "<br><h4 style='color: #0d82d3'>Username not found . Register First</h4><br>";
                                    echo "<input name=\"register\" value='Create Account' type=\"submit\" class=\"button contact_submit_button\">"?>
                                </form>
